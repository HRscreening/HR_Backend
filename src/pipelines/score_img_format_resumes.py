import asyncio
import httpx
from src.schemas.score_schema import ResumeDataSchemaURL,ResumeScoreFailure,ResumeScoreResult
from src.pipelines.score_resume_ocr import score_img_format_resume_file
